# MLB agent conventions (preserved from the pre-ACM CLAUDE.md)

> Captured verbatim during ACM adoption (2026-07-06). The managed CLAUDE.md is a
> routing manifest; these project-specific rules live here and are indexed in
> PSI_INDEX.md. The deploy details are expanded in `docs/dev-loop-playbook.md`.
